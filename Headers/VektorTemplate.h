//
// Created by ultra on 03.05.2023.
//

#ifndef LAB6_7_VEKTORTEMPLATE_H
#define LAB6_7_VEKTORTEMPLATE_H
...
public:
     ...
     *
     */
    Vektor& operator=(Vektor &&ot) noexcept ;
...
template<typename TElement>
void Vektor<TElement>::erase(int poz) {
...
template<typename TElement>
Vektor<TElement>::Vektor(Vektor<TElement> &&ot) noexcept {
    elems = ot.elems;
    lenght = ot.lenght;
    capacity = ot.capacity;
...
template<typename TElement>
Vektor<TElement> &Vektor<TElement>::operator=(Vektor<TElement> &&ot) noexcept {
    if (this == &ot) {
        return *this;
